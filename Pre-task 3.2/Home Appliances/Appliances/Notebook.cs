...
namespace Home_Appliances.Appliances
{
    ...
    {
        public Notebook(int id, string producer, string model, string color, int powerW, string cpu, int hddVolumeMb, int ramVolumeMb, string videoCardModel, string screenResolution, double diagonalInches, bool portative)
            : base(id, producer, model, color, powerW, cpu, hddVolumeMb, ramVolumeMb, videoCardModel, screenResolution, diagonalInches, true)
        {
